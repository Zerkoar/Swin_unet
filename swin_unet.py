...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, embed_dim, patch_size, in_c, norm_layer=None):
        super().__init__()
...
class Swin_Unet(nn.Module):
    ...
    def __init__(self, input_channels=1, patch_size=2, embed_dim=48, depths=(2, 2, 6, 2), num_heads=(3, 6, 12, 24),
        ...
        self.patch_embed = PatchEmbed(
            patch_size=patch_size, in_c=input_channels, embed_dim=embed_dim,
        ...
        for i in range(self.num_layers):
            ...
            layers = BasicLayer(dim=int(embed_dim * 2 ** i),
                                ...
                                norm_layer=norm_layer,
                                downsample=PatchMerging if (i < self.num_layers) else None,
